    ...
    return (
        <div className='place-order'>
            <div className="place-order-left">
                ...
                <input type="number" name='table_no' onChange={onChangeHandler} placeholder='Table no' />
                {/*<div className="multi-field">
            ...
            <div className="place-order-right">
                <div className="cart-total">
                    ...
                    <div>
                        ...
                        <hr />
                        <div className="cart-total-details"><p>GST tax</p><p>₹{getTotalCartAmount() === 0 ? 0 : 5}</p></div>
                        <hr />
                ...
                <div className="payment-options">
                    ...
                    {/*<div className="payment-option">
                        ...
                        <img src={assets.selector_icon} alt="" />
                        <p>UIP/Debit card/online payment</p>
                        </ul>
                    </div>*/}
                    <button onClick={() => window.open('https://razorpay.me/@yashodhahotel')}>Proceed to Pay</button>
                </div>
